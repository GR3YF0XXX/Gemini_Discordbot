...
# Generation settings for creativity and length
...
# Safety settings set to high threshold to allow for gritty Star Wars combat narrative
safety_settings = [
